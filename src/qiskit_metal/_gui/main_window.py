...
class MetalGUI(QMainWindowBaseHandler):
    ...
    def _ui_adjustments(self):
        ...
        # Compact the top toolbar. The .ui sets ToolButtonTextUnderIcon,
        # which stacks the label below a 24px icon and makes the bar roughly
        # twice as tall as it needs to be -- vertical space the canvas wants.
        # Beside-icon keeps every label readable at about half the height.
        ...
        self.ui.toolBarDesign.setToolButtonStyle(Qt.ToolButtonTextBesideIcon)
